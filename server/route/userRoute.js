...
const getAmazonExtra = require("../controller/getAmazonExtra");
const getAllImages = require("../controller/getAllImages");
const getAllBanner = require("../controller/getAllBanner");
const getAllVideos = require("../controller/getAllVideos");
const getAllManufacturing = require("../controller/getAllManufacturing");
const getAllThemes = require("../controller/getAllThemes");
